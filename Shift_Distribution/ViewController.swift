...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        designView.backgroundColor = UIColor(hex: "#c0c0c0ff")
    ...
    @objc func distribute() {
        var tmpPeople1 = people
        //tmpPeople1.shuffle()
        var tmpPeople2 = tmpPeople1
        //tmpPeople2.shuffle()
        tmpPeople2 = tmpPeople2.reversed()
        
//        for i in 0..<tmpPeople1.count {
//            if tmpPeople1[i] == tmpPeople2[i] { tmpPeople1.shuffle() }
//        }
        ...
        tmpPeople1 = people.shuffled()
        tmpPeople2 = tmpPeople1
        tmpPeople2 = tmpPeople2.reversed()
        
        ThirdLbl.text = tmpPeople2[0]
        tmpPeople2.remove(at: 0)
        ThirdLbl.text? += "\n" + tmpPeople2[0]
        tmpPeople2.remove(at: 0)
        ThirdLbl.text? += "\n" + tmpPeople2[0]
